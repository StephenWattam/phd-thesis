...
Efforts have been made~\cite{EagTcwgCtypeaglespreliminary}\td{comment on them}\cite{ide1995tei}%CITE EAGLES http://www.ilc.cnr.it/EAGLES96/intro.html
...
\til{
this is a transcription of the a3 sheet of notes, designed as an intermediate format before writing into the thesis..  it's organised in blocks of various smaller issues, each of which might become its own document eventually.
